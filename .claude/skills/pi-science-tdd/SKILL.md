---
name: pi-science-tdd
description: Use to write the failing test before the implementation change in pi-science, for bug fixes (strongly recommended) and feature work where the failure mode is testable in isolation.
---
...
2. Run it and confirm it fails for the right reason: `uv run --locked pytest`.
