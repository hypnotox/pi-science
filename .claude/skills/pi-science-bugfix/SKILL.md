...
description: Use when applying a bug fix in pi-science with a known root cause. Establishes the strongest practical durable oracle, fixes the root cause, verifies via the gate, commits, and evaluates review need. Self-contained.
---
