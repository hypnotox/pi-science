---
name: pi-science-refactor-coupling-audit
description: >
...
# pi-science-refactor-coupling-audit
...
This is a **support skill**: it sits off the workflow chain and does not gate it. Its output feeds the ADR's Context section before `pi-science-proposing-adr` finalises the Decision.
