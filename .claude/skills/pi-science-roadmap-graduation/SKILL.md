---
name: pi-science-roadmap-graduation
...
Evaluate continuity independently after identifying and re-verifying the item. Invoke `pi-science-effort-workflow` before ADR or implementation mutation only when durable continuity materially helps; otherwise graduation remains effort-free.


### 4. Graduate
- **Architectural -> ADR:** Invoke `pi-science-proposing-adr`.
