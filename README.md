...
Python currently generates local repeated-subexpression extraction, identical-call and reciprocal reuse, checked factoring, redundant-operation removal, and iterator-invariant hoisting. Every candidate passes the same exact-symbolic output proof and whole-computation aggregate-work comparison, including iterator cardinality, equation-output multiplicity, and generated-intermediate scope. Unknown costs, unresolved proof or cardinality, incompatible scopes, and nonpositive or incomparable reductions are omitted. Cross-equation sharing and Horner reformulation remain pending.
