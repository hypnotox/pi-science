...
Formula analysis returns bounded informational optimization advice by default (up to three suggestions); set `optimization.max_suggestions` to `0` to disable it. Advice is exact-symbolic, qualified abstract-work guidance, not a runtime claim.
