...
Paths: ["packages/pi-science/src/index.ts", "packages/pi-science/src/bridge.ts", "packages/pi-science/tests/start.test.ts", "packages/pi-science/tests/package.test.ts", "tsconfig.json"]
