...
6. `decision: python-policy-pi-transport` Python is the sole owner of goal normalization, search and proof policy, objective comparison, claim and result classification, and blockers. Pi uses protocol v17 to validate, correlate, and present the Python-owned contract without deriving mathematical policy.
