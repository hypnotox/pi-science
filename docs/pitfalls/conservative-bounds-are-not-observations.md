---
type: Reference
title: Conservative bounds are not observations
description: Hazard guidance for distinguishing safe conservative arithmetic bounds from exact observed values.
---
