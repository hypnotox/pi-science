...
- [Formula Component Boundaries](formula-component-boundaries.md): Internal responsibility ownership and dependency direction across formula analysis and Pi transport.
